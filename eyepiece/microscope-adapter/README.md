...
| Retention | radial **M3 screw + captive M3 nut** (pressed into a boss), clamps the barrel |
...
3. Print the full `adapter`; press an M3 nut into the boss, drop the eyepiece in
   (flange in the recess), and clamp with a radial M3 screw.
